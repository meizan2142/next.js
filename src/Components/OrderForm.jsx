...
const OrderForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.success) {
                console.log("Submission succeeded:", res.message);
                setFormData({
                    name: '',
                    phone: '',
                    district: '',
        ...
        <div className="flex items-center justify-center min-h-screen p-4">
            <div className="bg-[#EDDCD9] border-2 border-[#264143] rounded-2xl shadow-[3px_4px_0px_1px_#E99F4C] p-6 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-2">
                        <button className="w-full py-3 bg-[#DE5499] rounded-xl font-extrabold shadow-[3px_3px_0px_0px_#E99F4C] hover:opacity-90 focus:shadow-[1px_2px_0px_0px_#E99F4C] focus:translate-y-1 transition-all duration-150 my-6" disabled={pending}>
                            {pending ? "Processing...." : "Place an Order"}
                        </button>
                    </div>
                </form>
            </div>
